...
func main() {
	...
	// Initialize global transport for certificate management
	if err := scope.InitializeGlobalTransport(); err != nil {
		setupLog.Error(err, "unable to initialize global transport")
		os.Exit(1)
	}
